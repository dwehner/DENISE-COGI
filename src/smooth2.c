...
void  smooth2(float ** grad){
	...
	int tracl1, jj, ii, nmax, * win, NWINY1, NWINY2, NWINX1, NWINX2;
	...
	/* definition of smoothing window for the whole model*/
	/*NWINY1=0;
	NWINY2=n1;
	NWINX1=0;
	NWINX2=n2;*/
	
        /* definition of smoothing window for the whole Marmousi II model*/
	NWINY1=27;
	NWINY2=n1;
	NWINX1=0;
	NWINX2=n2;
